...
{
    public class BlackHorse : Figure
    {
        public Sprite spr { get; private set; }
        public Sprite smallspr { get; private set; }
        private Texture tex, smalltex;
        private string path = Environment.CurrentDirectory + "\\bhorse.png";
        private string smallpath = Environment.CurrentDirectory + "\\smallbhorse.png";
        public BlackHorse(int x, int y) : base(x, y,8)
        {

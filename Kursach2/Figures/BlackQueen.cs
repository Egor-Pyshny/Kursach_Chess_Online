...
namespace Kursach2.Figures
{
    public class BlackQueen : Figure
    {
		...
		private string path = Environment.CurrentDirectory + "\\bqueen.png";
		private string smallpath = Environment.CurrentDirectory + "\\smallbqueen.png";
		public BlackQueen(int x, int y) : base(x, y,11)
        {

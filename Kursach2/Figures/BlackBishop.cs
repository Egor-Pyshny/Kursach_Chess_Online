...
namespace Kursach2.Figures
{
    public class BlackBishop : Figure
    {
		...
		private string path = Environment.CurrentDirectory + "\\bbishop.png";
		private string smallpath = Environment.CurrentDirectory + "\\smallbbishop.png";
		public BlackBishop(int x, int y) : base(x, y,9)
        {
